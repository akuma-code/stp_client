...
export const SecondaryDescription: TerminsDesc = {
    ...
    Lt: 'Сколько света проходит через стекло (чем больше значение, тем прозрачнее)',
    Lr: 'Сколько света отражается от стекла (чем больше значение, тем лучше видно отражение)',
    Ra: 'На сколько искажаются  цвета через стекло (чем больше значение,  тем меньше стекло искажает цвета)',
    Det: 'Сколько проходит солнечного излучения через стекло (чем меньше значение, тем меньше света пройдет через стекло)',
    Er: 'Сколько солнечной энергии отражает стекло (чем больше значение, тем лучше отражение)',
    Ea: 'Сколько солнечной энергии поглощает стекло (чем больше значение,тем меньше стекло нагревается) ',
    Sf: 'Сколько солнечной энергии проходит через стекло (чем ниже значение, тем лучше стекло защищает от перегрева)',
    Sc: 'Сколько солнечных лучей проходит через стекло (чем меньше значение, тем меньше нагревается помещение)',
    S: 'Сколько света и солнца пропускает стекло (чем больше значение, тем  лучше защита от солнца и попадание света)',
