...
export const stpBackup_128: FetchedData[] = [
    ...
    ["4TopN-14Ar-6CEIпр", 0.90, 36, 59, 34, 98, 40, 37, 20, 47, 1.26, 25],
    ["4TopN-14Ar-6CBR20пр", 0.90, 36, 33, 31, 91, 23, 30, 47, 29, 1.14, 25],
    ["4TopN-14Ar-6CSGr40пр", 0.90, 36, 28, 30, 95, 21, 29, 51, 26, 1.08, 25],
    ["3.3.1-14Ar-4MFN", 0.90, 35, 64, 26, 97, 37, 32, 22, 42, 1.53, 25],
    ["4-16Ar-4MFN", 1.00, 30, 65, 26, 97, 40, 39, 19, 42, 1.55, 20],
    ["6-14Ar-4MFN", 0.90, 36, 64, 26, 97, 39, 36, 20, 42, 1.52, 25],
    ["4-16Ar-4LHSBrпр", 1.00, 30, 41, 18, 93, 29, 24, 47, 36, 1.14, 20],
    ["4-20Ar-4MFN", 0.90, 31, 65, 26, 97, 40, 39, 19, 43, 1.51, 20],
    ["4-20Ar-4LHSBrпр", 0.90, 31, 41, 18, 93, 29, 24, 47, 36, 1.14, 20],
    ["4-10-4-10Ar-4MFN", 0.90, 33, 59, 30, 97, 35, 43, 22, 40, 1.48, 30],
    ["4TopN-10Ar-4-12-6CEI+пр", 0.90, 36, 54, 37, 98, 36, 38, 25, 44, 1.23, 35],
    ["4TopN-10Ar-4-12-6CBR20пр", 0.90, 36, 30, 32, 91, 21, 32, 49, 27, 1.11, 35],
    ["4TopN-10Ar-4-12-6CSGr40пр", 0.90, 36, 25, 31, 94, 18, 32, 54, 24, 1.04, 35],
    ["4TopN-10(TGI)Ar-4-12(TGI)-6CEI+пр", 0.90, 36, 54, 37, 98, 36, 38, 25, 44, 1.23, 35],
    ["4TopN-10(TGI)Ar-4-12(TGI)-6CBR20пр", 0.90, 36, 30, 32, 91, 21, 32, 49, 27, 1.11, 35],
    ["4TopN-10(TGI)Ar-4-12(TGI)-6CSGr40пр", 0.90, 36, 25, 31, 94, 18, 32, 54, 24, 1.04, 35],
    ["4-12-4-12Ar-4MFN", 1.00, 33, 59, 30, 97, 35, 43, 22, 40, 1.48, 30],
    ["6-10-4-12Ar-4MFN", 1.00, 36, 59, 30, 96, 34, 43, 23, 40, 1.48, 35],
    ["4-12-4-12Ar-4LHSBrпр", 1.00, 33, 39, 20, 94, 37, 17, 46, 44, 1.30, 30],
    ["4TopN-14Ar-4-12-6CEI+пр", 1.00, 36, 54, 37, 98, 36, 38, 25, 43, 1.26, 35],
    ["4TopN-14Ar-4-12-6CBR20пр", 1.00, 36, 30, 32, 91, 21, 32, 49, 26, 1.15, 35],
    ["4TopN-14Ar-4-12-6CSGr40пр", 1.00, 36, 25, 31, 94, 18, 32, 54, 24, 1.04, 35],
    ["4TopN-14(TGI)Ar-4-12(TGI)-6CEI+пр", 1.00, 36, 54, 37, 98, 36, 38, 25, 43, 1.26, 35],
    ["4TopN-14(TGI)Ar-4-12(TGI)-6CBR20пр", 1.00, 36, 30, 32, 91, 21, 32, 49, 26, 1.15, 35],
    ["4TopN-14(TGI)Ar-4-12(TGI)-6CSGr40пр	", 1.00, 36, 25, 31, 94, 18, 32, 54, 24, 1.04, 35],
    ["4-14-4-14Ar-4MFN	", 1.11, 33, 59, 30, 97, 35, 43, 22, 40, 1.48, 30],
    ["4-14(TGI)-4-14(TGI)Ar-4MFN	", 1.11, 33, 59, 30, 97, 35, 43, 22, 40, 1.48, 30],
    ["4-12-4-16Ar-4MFN	", 1.25, 33, 59, 30, 97, 35, 43, 22, 40, 1.48, 30],
    ["4-14-4-14Ar-4LHSBrпр	", 1.11, 33, 39, 20, 94, 37, 17, 46, 44, 1.30, 30],
    ["6TopN-18(TGI)Ar-4-18(TGI)-6CEI+пр	", 1.11, 36, 54, 37, 97, 35, 35, 26, 43, 1.26, 40],
    ["6TopN-18(TGI)Ar-4-18(TGI)-6CBR20пр	", 1.11, 36, 30, 32, 92, 20, 30, 50, 26, 1.15, 40],
    ["6TopN-18(TGI)Ar-4-18(TGI)-6CSGr40пр	", 1.11, 36, 25, 31, 94, 18, 29, 54, 23, 1.09, 40],
    ["6-18-6-18Ar-4LHSBrпр	", 1.25, 36, 38, 20, 95, 34, 17, 49, 43, 1.35, 40],
    ["6TopN-18Ar-4-18-6CEI+пр	", 1.11, 36, 54, 37, 97, 35, 35, 26, 43, 1.26, 40],
    ["6TopN-18Ar-4-18-6CBR20пр	", 1.11, 36, 30, 32, 92, 20, 30, 50, 26, 1.15, 40],
    ["6TopN-18Ar-4-18-6CSGr40пр	", 1.11, 36, 25, 31, 94, 18, 29, 54, 23, 1.09, 40],
]
